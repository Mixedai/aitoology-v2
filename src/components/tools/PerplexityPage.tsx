...
export function PerplexityPage({ 
  ...
  const tool = getToolById('perplexity');
  ...
  const handleAddToWallet = () => {
    if (tool) {
      ...
      onNavigate?.(currentScreen || 'perplexity-page', 'wallet', {
  ...
  const handleBackToExplore = () => {
    onNavigate?.(currentScreen || 'perplexity-page', 'explore-frame');
  };

  const handleCompare = () => {
    if (tool) {
      onNavigate?.(currentScreen || 'perplexity-page', 'compare', {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">Perplexity AI information is not available.</p>
      ...
      <main id="main-content" className="max-w-7xl mx-auto p-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card>
              <CardHeader className="space-y-4">
                <h3>About Perplexity AI</h3>
              </CardHeader>
              <CardContent className="space-y-6">
                <p className="text-muted-foreground">
                  Perplexity AI is an answer engine that delivers accurate answers to complex questions using large language models. Unlike traditional search engines, Perplexity provides direct answers with cited sources, making it perfect for research, fact-checking, and learning. It combines the power of AI with real-time web search to give you comprehensive, up-to-date information.
                </p>
                ...
                <div className="border-t pt-6">
                  <h4 className="mb-4">How Perplexity Works</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-2">
                        <Search className="w-6 h-6 text-primary" />
                      </div>
                      <h5 className="mb-2">1. Ask a Question</h5>
                    ...
                    <div className="text-center">
                      ...
                      <h5 className="mb-2">2. Search & Analyze</h5>
                      <p className="text-sm text-muted-foreground">AI searches the web and analyzes sources</p>
                    </div>
                    <div className="text-center">
                      <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-2">
                        <BookOpen className="w-6 h-6 text-primary" />
                      </div>
                      <h5 className="mb-2">3. Get Cited Answers</h5>
                      <p className="text-sm text-muted-foreground">Receive comprehensive answers with sources</p>
                    </div>
                  </div>
                </div>

                <div className="bg-muted/50 p-4 rounded-lg">
                  <h5 className="mb-2">🔍 Perfect For</h5>
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Research and fact-checking</li>
                    <li>• Academic and professional inquiries</li>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card>
                    <CardHeader className="space-y-4">
                      <h4>Free</h4>
                      <p className="text-muted-foreground">Get started with Perplexity</p>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="text-2xl mb-4">$0/month</div>
                      <ul className="space-y-2 text-sm">
                        <li>• Quick searches and answers</li>
                  ...
                  <Card className="border-primary">
                    <CardHeader className="space-y-4">
                      <h4>Pro</h4>
                      <p className="text-muted-foreground">Enhanced AI research</p>
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <ul className="space-y-2 text-sm">
                        ...
                        <li>• 300+ Pro searches daily</li>
                        <li>• GPT-4 and Claude-3 access</li>
                ...
                <div className="bg-muted/50 p-4 rounded-lg">
                  <h5 className="mb-2">💡 What are Pro Searches?</h5>
                  <p className="text-sm text-muted-foreground">
                    Pro searches use advanced AI models (GPT-4, Claude-3, Gemini) for more detailed analysis, 
                    complex reasoning, and comprehensive answers to research-intensive questions.
                  </p>
                </div>
              </CardContent>
            </Card>
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h4>ChatGPT</h4>
                          <p className="text-muted-foreground text-sm">Conversational AI assistant for various tasks and questions</p>
                        </div>
                        <Button size="sm" variant="outline" onClick={() => onNavigate?.(currentScreen || 'perplexity-page', 'tool-detail', { tool_id: 'chatgpt' })}>
                          View
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h4>Claude</h4>
                          <p className="text-muted-foreground text-sm">AI assistant focused on helpful, harmless conversations</p>
                        </div>
                        <Button size="sm" variant="outline" onClick={() => onNavigate?.(currentScreen || 'perplexity-page', 'tool-detail', { tool_id: 'claude' })}>
                          View
                        </Button>
                      </div>
                    </CardContent>
