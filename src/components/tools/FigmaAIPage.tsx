...
export function FigmaAIPage({ 
  ...
  const tool = getToolById('figma-ai');
  ...
  const handleAddToWallet = () => {
    if (tool) {
      ...
      onNavigate?.(currentScreen || 'figma-ai-page', 'wallet', {
  ...
  const handleBackToExplore = () => {
    onNavigate?.(currentScreen || 'figma-ai-page', 'explore-frame');
  };

  const handleCompare = () => {
    if (tool) {
      onNavigate?.(currentScreen || 'figma-ai-page', 'compare', {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">Figma AI information is not available.</p>
      ...
      <main id="main-content" className="max-w-7xl mx-auto p-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card>
              <CardHeader className="space-y-4">
                <h3>About Figma AI</h3>
              </CardHeader>
              <CardContent className="space-y-6">
                <p className="text-muted-foreground">
                  Figma AI brings artificial intelligence directly into your design workflow. From generating content to automating layouts, these AI features help designers work faster and more efficiently within the Figma platform.
                </p>
                ...
                <div className="border-t pt-6">
                  <h4 className="mb-4">AI Design Features</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-2">
                        <Layers className="w-6 h-6 text-primary" />
                      </div>
                      <h5 className="mb-2">Auto Layout</h5>
                      <p className="text-muted-foreground">Intelligent layout suggestions</p>
                    </div>
                    <div className="text-center">
                      <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-2">
                        <Wand2 className="w-6 h-6 text-primary" />
                      </div>
                      <h5 className="mb-2">Content Fill</h5>
                      <p className="text-muted-foreground">AI-generated placeholder content</p>
                    </div>
                    <div className="text-center">
                      <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-2">
                        <Sparkles className="w-6 h-6 text-primary" />
                      </div>
                      <h5 className="mb-2">Design Suggestions</h5>
                      <p className="text-muted-foreground">Smart design recommendations</p>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Card>
                    <CardHeader className="space-y-4">
                      <h4>Free</h4>
                      <p className="text-muted-foreground">Basic AI features</p>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="mb-6">$0/month</div>
                      <ul className="space-y-2">
                        <li>• Limited AI suggestions</li>
                        <li>• Basic content fill</li>
                  ...
                  <Card className="border-primary">
                    <CardHeader className="space-y-4">
                      <h4>Professional</h4>
                      <p className="text-muted-foreground">Full AI capabilities</p>
                  ...
                  <Card>
                    <CardHeader className="space-y-4">
                      <h4>Organization</h4>
                      <p className="text-muted-foreground">Enterprise features</p>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="mb-6">$45/month</div>
                      <ul className="space-y-2">
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-muted-foreground">Open-source AI image generation</p>
                        </div>
                        <Button size="sm" variant="outline" onClick={() => onNavigate?.(currentScreen || 'figma-ai-page', 'tool-detail', { tool_id: 'stable-diffusion' })}>
                          View
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h4>Midjourney</h4>
                          <p className="text-muted-foreground">AI art generation platform</p>
                        </div>
                        <Button size="sm" variant="outline" onClick={() => onNavigate?.(currentScreen || 'figma-ai-page', 'tool-detail', { tool_id: 'midjourney' })}>
                          View
                        </Button>
                      </div>
                    </CardContent>
